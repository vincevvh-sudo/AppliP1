...
const IconLalilo = () => (
  <svg className="h-16 w-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h10M7 11h10M7 15h6M6 3h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5a2 2 0 012-2z" />
  </svg>
);
...
const CARDS = [
  ...
  { href: "https://student.lalilo.com/#/class/952786", icon: IconLalilo, title: "Lalilo", desc: "Aller sur Lalilo (site internet)", color: "bg-[#ffd4a3]/80", hoverColor: "hover:bg-[#ffd4a3]" },
];
...
export default function EnfantPage() {
  ...
  const [session, setSession] = useState<{ id: string | number; prenom: string; nom: string } | null>(null);
