...
export default function EnseignantDicteeTestPage() {
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-5 py-12">
        {!tousVerifies ? (
          <>
            ...
            <div className="mt-8 rounded-2xl bg-white/95 p-8 shadow-xl">
              <p className="text-center text-[#2d4a3e]/70">
                Écoute la syllabe, puis écris-la dans la case (comme un élève).
              </p>
          ...
          <div className="rounded-2xl bg-white/95 p-8 shadow-xl text-center">
            <h2 className="font-display text-2xl text-[#2d4a3e]">Test terminé</h2>
            <p className="mt-4 text-3xl font-bold text-[#4a7c5a]">
              {score} / {syllabes.length}
            </p>
            <Link
              href="/enseignant/sons/evaluation-5"
              className="mt-8 inline-block rounded-xl bg-[#4a7c5a] px-8 py-3 font-semibold text-white transition hover:bg-[#3d6b4d]"
            >
              ← Retour à l&apos;Évaluation 5
            </Link>
          </div>
