...
export default function EnseignantMathsEvaluationPage() {
  return (
    <main className="relative min-h-screen overflow-hidden text-[#2d4a3e]">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-5 py-12">
        ...
        <p className="mt-2 text-sm text-[#2d4a3e]/75">
          Choisis une partie. (À déployer plus tard.)
        </p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          {PARTIES_MATHS.map((partie) => (
            <Link
              key={partie.id}
              href={`/enseignant/maths/evaluation/${partie.id}`}
        ...
        <Link href="/enseignant/maths" className="mt-12 inline-block rounded-xl bg-[#c4a8e8]/80 px-6 py-3 font-medium text-[#2d4a3e] transition hover:bg-[#c4a8e8]">
          ← Retour
        </Link>
      </div>
    </main>
