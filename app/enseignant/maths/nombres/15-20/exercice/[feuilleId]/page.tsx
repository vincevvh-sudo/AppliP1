...
import { FEUILLES_NOMBRES_15_20 } from "../../../../../../data/maths-data";

export default function EnseignantMathsNombres1520FeuillePage() {
  const params = useParams();
  const feuilleId = params?.feuilleId as string;
  const feuille = FEUILLES_NOMBRES_15_20.find((f) => f.id === feuilleId);
    ...
    return (
      <main className="relative min-h-screen overflow-hidden text-[#2d4a3e]">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-5 py-12">
          ...
          <Link href="/enseignant/maths/nombres/15-20" className="mt-4 inline-block text-[#4a7c5a]">← Les nombres de 15 à 20</Link>
        </div>
      </main>
    );
  }
    ...
    <main className="relative min-h-screen overflow-hidden text-[#2d4a3e]">
      ...
      <header className="relative z-10 border-b border-[#2d4a3e]/10 bg-[#fef9f3]/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-4">
          <span className="font-display text-xl text-[#2d4a3e]">{feuille.titre} — Nombres 15 à 20</span>
          <Link
            href="/enseignant/maths/nombres/15-20"
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-5 py-12">
        ...
        <Link href="/enseignant/maths/nombres/15-20" className="mt-8 inline-block rounded-xl bg-[#c4a8e8]/80 px-6 py-3 font-medium text-[#2d4a3e] transition hover:bg-[#c4a8e8]">
          ← Retour aux feuilles
        </Link>
      </div>
    </main>
