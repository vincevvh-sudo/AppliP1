...
export default function EnseignantMathsPartiePage() {
    ...
    <main className="relative min-h-screen overflow-hidden text-[#2d4a3e]">
      ...
      <header className="relative z-10 border-b border-[#2d4a3e]/10 bg-[#fef9f3]/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-4">
          <Link href="/enseignant/maths" className="flex items-center gap-2 font-display text-xl tracking-wide text-[#2d4a3e]">
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-5 py-12">
        ...
        <p className="mt-2 text-sm text-[#2d4a3e]/75">Choisis un thème.</p>
        ...
        {partie.themes.length === 0 ? (
          ...
          <div className="mt-6 grid gap-3">
            {partie.themes.map((theme) => (
              <Link
                key={theme.id}
                href={`/enseignant/maths/${partieId}/${theme.id}`}
        ...
        <Link href="/enseignant/maths" className="mt-10 inline-block rounded-xl bg-[#c4a8e8]/80 px-6 py-3 font-medium text-[#2d4a3e] transition hover:bg-[#c4a8e8]">
          ← Retour
        </Link>
      </div>
    </main>
