...
export default function EnseignantMathsPage() {
  return (
    <main className="relative min-h-screen overflow-hidden text-[#2d4a3e]">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          <Link
            href="/enseignant/maths/exercice"
          ...
          <Link
            href="/enseignant/maths/evaluation"
            className="rounded-2xl bg-white/95 p-8 shadow-lg transition hover:-translate-y-1 hover:bg-[#c4a8e8]/20"
          >
        ...
        <Link href="/enseignant" className="mt-12 inline-block rounded-xl bg-[#c4a8e8]/80 px-6 py-3 font-medium text-[#2d4a3e] transition hover:bg-[#c4a8e8]">
