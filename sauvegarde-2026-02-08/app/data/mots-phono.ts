...
const MOTS_PAR_SON: Record<string, string[]> = {
  ...
  m: ["ma", "maman", "miel", "moto", "maison", "mouton", "melon"],
  ...
  n: ["nez", "nez", "noix", "nature", "note", "navet", "nuage"],
  p: ["pain", "papa", "pomme", "poule", "porte", "pédale"],
  t: ["toi", "tu", "tapis", "table", "tomate", "télé", "tête"],
  f: ["feu", "fête", "fois", "four", "fusée", "filet", "frais"],
  v: ["vélo", "vache", "voix", "vol", "vent", "ville", "vert"],
  ch: ["chat", "chien", "chou", "chant", "chapeau", "chocolat"],
  j: ["jupe", "jouer", "jus", "jardin", "jeu", "juillet"],
  b: ["bébé", "ballon", "boîte", "banane", "brosse", "bulle"],
  d: ["dos", "doigt", "dé", "dimanche", "domino", "drapeau"],
  g: ["gare", "gant", "gomme", "gâteau", "guitare", "garage"],
